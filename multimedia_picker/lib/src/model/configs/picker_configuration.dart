...
class PickerConfiguration {
  ...
  /// Defaults to empty string - random UUID with `multimedia_` prefix.
  ...
  PickerConfiguration copyWith({
    ...
    alwaysRequestOriginal: alwaysRequestOriginal ?? this.alwaysRequestOriginal,
    ...
    saveNewImageAfterEdit: saveNewImageAfterEdit ?? this.saveNewImageAfterEdit,
  ...
  @override
  String toString() =>
      'PickerConfiguration(maxSelectCount: $maxSelectCount, '
