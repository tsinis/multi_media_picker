...
class UiConfigurationListView extends BaseConfigListView<UiConfiguration> {
  const UiConfigurationListView(
    ...
    this.animateSelectButtonWhenSelectInPreviewSubtitle = const SelectableText(
      'animateSelectButtonWhenSelectInPreview',
    ),
    this.animateSelectButtonWhenSelectInPreviewTitle = const Text(
      'Animate Select Button When Select In Preview',
    ),
    this.animateSelectButtonWhenSelectInThumbnailSubtitle =
        const SelectableText('animateSelectButtonWhenSelectInThumbnail'),
    this.animateSelectButtonWhenSelectInThumbnailTitle = const Text(
      'Animate Select Button When Select In Thumbnail',
    ),
    this.cellCornerRadioDecoration = const InputDecoration(
      hintText: 'Cell Corner Radius',
    ),
    this.cellCornerRadioSubtitle = const SelectableText('cellCornerRadio'),
    this.columnCountDecoration = const InputDecoration(
    ...
    this.isDarkStatusBarStyleSubtitle = const SelectableText(
    ...
    this.minimumItemSpacingDecoration = const InputDecoration(
      hintText: 'Minimum Item Spacing',
    ),
    this.minimumItemSpacingSubtitle = const SelectableText(
      'minimumItemSpacing',
    ),
    this.minimumLineSpacingSubtitle = const SelectableText(
      'minimumLineSpacing',
    ),
    this.minimumLineSpacingTitle = const Text('Minimum Line Spacing'),
    this.navCancelButtonStyleSubtitle = const SelectableText(
      'navCancelButtonStyle',
    ),
    this.navCancelButtonStyleTitle = const Text('Nav Cancel Button Style'),
    this.selectButtonAnimationDurationSubtitle = const SelectableText(
      'selectButtonAnimationDuration',
    ),
    this.selectButtonAnimationDurationTitle = const Text(
      'Select Button Animation Duration',
    ),
    ...
    this.showAddPhotoButtonSubtitle = const SelectableText(
      'showAddPhotoButton',
    ),
    this.showAddPhotoButtonTitle = const Text('Show Add Photo Button'),
    this.showCaptureImageOnTakePhotoButtonSubtitle = const SelectableText(
      'showCaptureImageOnTakePhotoButton',
    ),
    this.showCaptureImageOnTakePhotoButtonTitle = const Text(
      'Show Capture Image On Take Photo Button',
    ),
    this.showEnterSettingTipsSubtitle = const SelectableText(
      'showEnterSettingTips',
    ),
    this.showEnterSettingTipsTitle = const Text('Show Enter Setting Tips'),
    this.showIndexOnSelectButtonSubtitle = const SelectableText(
      'showIndexOnSelectButton',
    ),
    this.showIndexOnSelectButtonTitle = const Text(
      'Show Index On Select Button',
    ),
    this.showInvalidMaskSubtitle = const SelectableText('showInvalidMask'),
    this.showInvalidMaskTitle = const Text('Show Invalid Mask'),
    this.showScrollToBottomButtonSubtitle = const SelectableText(
      'showScrollToBottomButton',
    ),
    this.showScrollToBottomButtonTitle = const Text(
      'Show Scroll To Bottom Button',
    ),
    this.showSelectedBorderSubtitle = const SelectableText(
      'showSelectedBorder',
    ),
    ...
    this.showSelectedPhotoPreviewSubtitle = const SelectableText(
      'showSelectedPhotoPreview',
    ),
    this.showSelectedPhotoPreviewTitle = const Text(
      'Show Selected Photo Preview',
    ),
    this.showStatusBarInPreviewInterfaceSubtitle = const SelectableText(
      'showStatusBarInPreviewInterface',
    ),
    this.showStatusBarInPreviewInterfaceTitle = const Text(
      'Show Status Bar In Preview Interface',
    ),
    ...
    this.themeColorDecoration = const InputDecoration(
      hintText: 'Theme Color (ARGB)',
    ),
  ...
  List<Widget> childrenBuilder(
    ...
    if (cellCornerRadioSubtitle != null && cellCornerRadioDecoration != null)
      ListTile(
