...
struct RawOverlayImage: Hashable {
  var path: String
  var isAsset: Bool
  var opacity: Double
  ...
  static func == (lhs: RawOverlayImage, rhs: RawOverlayImage) -> Bool {
...
/// Generated class from Pigeon that represents data sent in messages.
struct RawLocalizations: Hashable {
  ...
  static func == (lhs: RawLocalizations, rhs: RawLocalizations) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct RawUiConfiguration: Hashable {
  ...
  static func == (lhs: RawUiConfiguration, rhs: RawUiConfiguration) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct ClipAspectRatio: Hashable {
  ...
  static func == (lhs: ClipAspectRatio, rhs: ClipAspectRatio) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
struct ClipOptions: Hashable {
  ...
  static func == (lhs: ClipOptions, rhs: ClipOptions) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct RawMediaData: Hashable {
  var path: String
  var thumbPath: String? = nil
  var type: MediaType
  var durationSec: Int64? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RawMediaData? {
    ...
    let durationSec: Int64? = nilOrValue(pigeonVar_list[3])
  ...
  static func == (lhs: RawMediaData, rhs: RawMediaData) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct RawPickerConfiguration: Hashable {
  ...
  static func == (lhs: RawPickerConfiguration, rhs: RawPickerConfiguration) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct RawEditConfiguration: Hashable {
  var tools: [EditTool]
  ...
  static func == (lhs: RawEditConfiguration, rhs: RawEditConfiguration) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
/// Generated class from Pigeon that represents data sent in messages.
struct RawCameraConfiguration: Hashable {
  var allowTakePhoto: Bool
  var allowRecordVideo: Bool
  var captureTimerSeconds: Int64
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RawCameraConfiguration? {
    ...
    let captureTimerSeconds = pigeonVar_list[2] as! Int64
    let minDurationSeconds = pigeonVar_list[3] as! Int64
    let maxDurationSeconds = pigeonVar_list[4] as! Int64
    let isFrontVideoMirrored = pigeonVar_list[5] as! Bool
  ...
  static func == (lhs: RawCameraConfiguration, rhs: RawCameraConfiguration) -> Bool {
    return deepEqualsmessages(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashmessages(value: toList(), hasher: &hasher)
  }
...
private class MessagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 144:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return CameraOrientation(rawValue: enumResultAsInt)
      }
      return nil
    case 145:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? CaptureSessionPreset {
      ...
      super.writeByte(143)
      super.writeValue(value.rawValue)
    } else if let value = value as? CameraOrientation {
      super.writeByte(144)
      super.writeValue(value.rawValue)
...
class MultiMediaApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MultiMediaApi?, messageChannelSuffix: String = "") {
    ...
    let openCameraChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.multimedia_picker.MultiMediaApi.openCamera\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let editMediaChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.multimedia_picker.MultiMediaApi.editMedia\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let openGalleryChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.multimedia_picker.MultiMediaApi.openGallery\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
